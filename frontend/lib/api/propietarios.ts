...
export async function createPropietario(owner: Omit<Owner, "id" | "mascotas">): Promise<Owner> {
  const data = await api.post<PropietarioAPI>("/propietarios", mapOwnerToPropietario(owner));
