...
- Name: cliente-audit.spec.ts >> Auditoría Cliente — Nueva cita (/cliente/agendar/nueva) >> paso 1 → botón Siguiente está deshabilitado sin mascota seleccionada
- Location: e2e\cliente-audit.spec.ts:227:7
