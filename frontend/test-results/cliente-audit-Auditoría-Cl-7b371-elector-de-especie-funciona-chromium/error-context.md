...
- Name: cliente-audit.spec.ts >> Auditoría Cliente — Mascotas (/cliente/mascotas) >> selector de especie funciona
- Location: e2e\cliente-audit.spec.ts:299:7

# Error details

```
TimeoutError: locator.selectOption: Timeout 8000ms exceeded.
Call log:
