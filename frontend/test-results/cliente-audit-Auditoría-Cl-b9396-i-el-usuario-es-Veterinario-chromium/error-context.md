...
- Name: cliente-audit.spec.ts >> Auditoría Cliente — Autenticación y protección de rutas >> redirige a /veterinario si el usuario es Veterinario
- Location: e2e\cliente-audit.spec.ts:129:7
