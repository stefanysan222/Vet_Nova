            ...
            <section className="rounded-[2rem] border border-slate-200/60 bg-white/95 p-6 shadow-[0_28px_80px_rgba(15,23,42,0.08)] dark:border-slate-700 dark:bg-slate-950">
              ...
              <div className="mt-8 grid gap-6 lg:grid-cols-2">
                <div className="rounded-3xl border border-slate-200/70 bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-900">
                  <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Métricas clave</h2>
                  <p className="mt-3 text-sm text-slate-600 dark:text-slate-400">Observa los indicadores más importantes de tu clínica.</p>
                </div>
                <div className="rounded-3xl border border-slate-200/70 bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-900">
                  <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Comparativa mensual</h2>
                  <p className="mt-3 text-sm text-slate-600 dark:text-slate-400">Compara resultados con los meses anteriores.</p>
                </div>
              </div>
            </section>
          </main>
