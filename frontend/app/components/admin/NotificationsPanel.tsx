    ...
    <div className="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm shadow-slate-200/40">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-blue-100">
      ...
      <div className="space-y-3">
        {notifications.map((note, i) => (
          <div
            key={i}
            className={`rounded-2xl border border-slate-200/50 ${note.color} p-4 transition hover:shadow-sm`}
          >
      ...
      <button className="mt-6 w-full rounded-2xl bg-slate-100 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-200">
