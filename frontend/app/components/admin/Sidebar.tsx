...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden lg:flex lg:h-screen lg:w-[320px] lg:flex-col lg:border-r lg:border-slate-200/70 lg:bg-white lg:px-6 lg:py-8 lg:shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
        <div className="flex flex-col gap-8">
          <div className="space-y-3">
            ...
            <div className="rounded-[2rem] border border-slate-200/70 bg-slate-50 p-5 shadow-sm shadow-slate-200/50">
        ...
        <div className="mt-auto space-y-4 rounded-[2rem] border border-slate-200/70 bg-slate-50 p-5 shadow-sm shadow-slate-200/50">
          ...
          <button className="w-full rounded-3xl bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-sm transition hover:bg-slate-100">
            Cerrar sesión
          </button>
        </div>
      </aside>
        ...
        {mobileOpen ? (
          ...
          >
            <motion.aside
              ...
              className="absolute left-0 top-0 bottom-0 w-[280px] bg-white px-5 py-8 shadow-2xl"
