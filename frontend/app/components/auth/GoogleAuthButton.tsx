...
export default function GoogleAuthButton({ label, onSuccess }: GoogleAuthButtonProps) {
  ...
  if (!clientId) {
    return (
      <button type="button" disabled className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-400 opacity-50 cursor-not-allowed">
