...
export const COMMON_STYLES = {
  ...
  section:   "mt-20",
  card:      "rounded-2xl border border-surface-200 bg-white shadow-card transition hover:shadow-card-md",
  button: {
    primary:   "inline-flex items-center justify-center rounded-xl bg-brand-600 px-7 py-3 text-sm font-semibold text-white transition hover:bg-brand-700",
    secondary: "inline-flex items-center justify-center rounded-xl border border-surface-200 bg-white px-7 py-3 text-sm font-semibold text-surface-900 transition hover:bg-surface-50",
  },
  text: {
