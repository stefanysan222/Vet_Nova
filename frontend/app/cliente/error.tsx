...
export default function AdminError({
  ...
  return (
    <div className="dark:bg-danger-950/10 flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-danger-100 bg-danger-50/40 px-6 text-center dark:border-danger-900/30">
      ...
      <button
        onClick={reset}
        className="mt-6 inline-flex h-10 items-center rounded-xl bg-danger-500 px-5 text-sm font-semibold text-white transition hover:bg-danger-600 active:scale-[0.98]"
      >
        Intentar de nuevo
      </button>
    </div>
